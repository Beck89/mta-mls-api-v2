...
CREATE INDEX "idx_lookups_system_name" ON "lookups" USING btree ("originating_system" text_ops,"lookup_name" text_ops);--> statement-breakpoint
CREATE INDEX "idx_price_history_listing" ON "price_history" USING btree ("listing_key" text_ops);--> statement-breakpoint
CREATE INDEX "idx_price_history_recorded" ON "price_history" USING btree ("recorded_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "idx_change_log_listing_field" ON "property_change_log" USING btree ("listing_key" text_ops,"field_name" text_ops);--> statement-breakpoint
CREATE INDEX "idx_change_log_recorded" ON "property_change_log" USING btree ("recorded_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "idx_status_history_listing" ON "status_history" USING btree ("listing_key" text_ops);--> statement-breakpoint
CREATE INDEX "idx_status_history_recorded" ON "status_history" USING btree ("recorded_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "idx_media_downloads_at" ON "media_downloads" USING btree ("downloaded_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "idx_media_downloads_run" ON "media_downloads" USING btree ("run_id" int8_ops);--> statement-breakpoint
CREATE INDEX "idx_repl_requests_at" ON "replication_requests" USING btree ("requested_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "idx_repl_requests_run" ON "replication_requests" USING btree ("run_id" int8_ops);--> statement-breakpoint
CREATE INDEX "idx_media_listing_order" ON "media" USING btree ("listing_key" int4_ops,"media_order" int4_ops);--> statement-breakpoint
CREATE INDEX "idx_media_resource_type" ON "media" USING btree ("resource_type" text_ops);--> statement-breakpoint
CREATE INDEX "idx_media_status" ON "media" USING btree ("status" text_ops);--> statement-breakpoint
CREATE INDEX "idx_properties_city" ON "properties" USING btree ("city" text_ops);--> statement-breakpoint
CREATE INDEX "idx_properties_geog" ON "properties" USING gist ("geog" gist_geography_ops);--> statement-breakpoint
CREATE INDEX "idx_properties_list_price" ON "properties" USING btree ("list_price" numeric_ops);--> statement-breakpoint
CREATE INDEX "idx_properties_mlg_can_use" ON "properties" USING gin ("mlg_can_use" array_ops);--> statement-breakpoint
CREATE INDEX "idx_properties_modification_ts" ON "properties" USING btree ("modification_ts" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "idx_properties_postal_code" ON "properties" USING btree ("postal_code" text_ops);--> statement-breakpoint
CREATE INDEX "idx_properties_property_type" ON "properties" USING btree ("property_type" text_ops);--> statement-breakpoint
CREATE INDEX "idx_properties_standard_status" ON "properties" USING btree ("standard_status" text_ops);--> statement-breakpoint
CREATE INDEX "idx_properties_status_type_price" ON "properties" USING btree ("standard_status" text_ops,"property_type" numeric_ops,"list_price" text_ops);--> statement-breakpoint
CREATE INDEX "idx_properties_subdivision" ON "properties" USING btree ("subdivision_name" text_ops);--> statement-breakpoint
